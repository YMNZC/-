...
<head>
    ...
    <script language="javascript">
        ...
        //跳转到子表dingdan添加页面
        function fukuanfangshidingdanAddQian(id) {
            var url="${contextPath}/fukuanfangshidingdanAddQian/"+id;
            window.location.href=url;
        }
        //跳转到子表dingdan查看页面
        function fukuanfangshidingdanGetByfukuanfangshiidQian(id) {
            var url="${contextPath}/fukuanfangshidingdanGetByfukuanfangshiidQian/"+id;
            window.location.href=url;
        }
    ...
    <tr>
        ...
        <td width="39%">
            ${fukuanfangshi.mingcheng }
                ...
                <input type="button" value="订单添加" onclick="fukuanfangshidingdanAddQian(${fukuanfangshi.id})"/>
                <input type="button" value="订单查看" onclick="fukuanfangshidingdanGetByfukuanfangshiidQian(${fukuanfangshi.id})"/>
