...
<div class="index_about index">
    <div class="w1200">
        ...
        订单金额:<input type="text" style='border:solid 1px #000000; color:#666666' name="jine" id="jine" size="12px" value="${req.jine}"/>&nbsp;&nbsp;
        是否支付:
        <select name="zhifushenhe" id="zhifushenhe" size="1px" >
        ...
        是否发货:
        <select name="fahuoshenhe" id="fahuoshenhe" size="1px" >
            <option value="">全部</option>
        ...
        是否收货:
        <select name="shouhuoshenhe" id="shouhuoshenhe" size="1px" >
            <option value="">全部</option>
        ...
        付款方式:
        <select style="border:solid 1px #000000; color:#666666;" name="fukuanfangshiid" id="fukuanfangshiid">
            <option value="">全部</option>
        ...
        送货地址:<input type="text" style='border:solid 1px #000000; color:#666666' name="dizhi" id="dizhi" size="12px" value="${req.dizhi}"/>&nbsp;&nbsp;
        商家ID:<input type="text" style='border:solid 1px #000000; color:#666666' name="shangjia" id="shangjia" size="12px" value="${req.shangjia}"/>&nbsp;&nbsp;
<%--        用户:
        ...
        物流信息:<input type="text" style='border:solid 1px #000000; color:#666666' name="wuliu" id="wuliu" size="12px" value="${req.wuliu}"/>&nbsp;&nbsp;
        备注:<input type="text" style='border:solid 1px #000000; color:#666666' name="beizhu" id="beizhu" size="12px" value="${req.beizhu}"/>&nbsp;&nbsp;
...
<%--                    <td width="40px" align="center" bgcolor="">序号</td>--%>
        ...
        <td bgcolor='' align="center">订单金额</td>
        <td bgcolor='' align="center">是否支付</td>
        <td bgcolor='' align="center">是否发货</td>
        <td bgcolor='' align="center">是否收货</td>
        <td bgcolor='' align="center">付款方式</td>
        <td bgcolor='' align="center">姓名</td>
        <td bgcolor='' align="center">电话</td>
        <td bgcolor='' align="center">送货地址</td>
        <td bgcolor='' align="center">商家ID</td>
        <td bgcolor='' align="center">用户</td>
        <td bgcolor='' align="center">时间</td>
        <td bgcolor='' align="center">物流信息</td>
        <td bgcolor='' align="center">备注</td>
