...
<%--        用户:
        ...
        回复:<input type="text" style='border:solid 1px #000000; color:#666666' name="huifu" id="huifu" size="12px" value="${req.huifu}"/>&nbsp;&nbsp;
...
<%--                    <td width="40px" align="center" bgcolor="">序号</td>--%>
        ...
        <td bgcolor='' align="center">留言时间</td>
        <td bgcolor='' align="center">用户</td>
        <td bgcolor='' align="center">回复</td>
