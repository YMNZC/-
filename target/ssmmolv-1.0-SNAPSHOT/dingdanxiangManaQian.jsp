...
<div class="index_about index">
    <div class="w1200">
        ...
        订单:
        <select style="border:solid 1px #000000; color:#666666;" name="dingdanid" id="dingdanid">
            ...
            <td bgcolor="" align="center">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <td width="40px" align="center">
                            <a href="${contextPath}/dingdanxiangDetailQian/${info.id}">
                                详细
                            </a>
                        </td>
                    </tr>
