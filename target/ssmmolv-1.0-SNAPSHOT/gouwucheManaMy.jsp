    ...
    <script type="text/javascript">
        ...
        function gouwucheDel(id) {
            if (confirm('您确定删除吗?')) {
                $.get(basePath + '/gouwucheDel/' + id, function (resp) {
                    if (resp.success) {
                        alert("删除成功！");
                        //window.location.href = "${contextPath}/gouwucheManaMy";
        ...
        function gouwucheSet(id,property,value) {
            if (confirm('您确定操作吗?')) {
                ...
                $.post(basePath + '/gouwucheAddOrUpdate', param, function(resp) {
                    if (resp.success) {
                        alert("操作成功！");
                        //window.location.href = "${contextPath}/gouwucheManaMy";
                        document.formSearch.submit();
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px"
       bordercolor="#008080">
    <form action="${contextPath}/gouwucheManaMy" name="formSearch" id="formSearch" method="post">
        商品:
...
<%--        用户:
    ...
    <tr bgcolor="#E7E7E7">
        <td height="14" colspan="100" background="${staticPath}/images/tbg.gif">购物车管理</td>
    </tr>
