...
<div class="index_about index">
    <div class="w1200">
        ...
        支付方式:<input type="text" style='border:solid 1px #000000; color:#666666' name="mingcheng" id="mingcheng" size="12px" value="${req.mingcheng}"/>&nbsp;&nbsp;
...
<%--                    <td width="40px" align="center" bgcolor="">序号</td>--%>
                            <td bgcolor='' align="center">支付方式</td>
...
<%--                        </td>--%>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <td width="40px" align="center">
                            <a href="${contextPath}/fukuanfangshiDetailQian/${info.id}">
                                详细
                            </a>
                        </td>
                    </tr>
