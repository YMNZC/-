...
<head>
    <title>商品收藏管理列表</title>
    <%@include file="common/head.jsp" %>
    <%@include file="common/loginstate.jsp" %>
    <script type="text/javascript">
        //导出信息
        function daochu() {
            var url = "${contextPath}/shoucangManaMy?d=1";
        ...
        function shoucangDel(id) {
            if (confirm('您确定删除吗?')) {
                $.get(basePath + '/shoucangDel/' + id, function (resp) {
                    if (resp.success) {
                        alert("删除成功！");
                        //window.location.href = "${contextPath}/shoucangManaMy";
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px"
       bordercolor="#008080">
    <form action="${contextPath}/shoucangManaMy" name="formSearch" id="formSearch" method="post">
        商品:
...
<%--        用户:
    ...
    <tr bgcolor="#E7E7E7">
        <td height="14" colspan="100" background="${staticPath}/images/tbg.gif">商品收藏管理</td>
    </tr>
