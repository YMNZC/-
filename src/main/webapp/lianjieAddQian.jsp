        ...
        function lianjieAdd() {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.success) {
                        alert("添加成功！");
                        //window.location.href = "${contextPath}/lianjieManaMyQian";
                    } else {
                        alert(resp.message);
                    }
                }
...
<div class="index_about index">
    <div class="w1200">
		...
		<tr>
            ...
            <td>
                <input type="text" name="name" id="name" size="70px"/>
            </td>
		...
		<tr>
            ...
            <td>
                <input type="text" name="url" id="url" size="70px"/>
            </td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2">
                            <input type="button" name="Submit5" value="提交" onClick="lianjieAdd();" />
