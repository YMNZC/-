...
<div class="index_about index">
    <div class="w1200">
        ...
        名称:<input type="text" style='border:solid 1px #000000; color:#666666' name="name" id="name" size="12px" value="${req.name}"/>&nbsp;&nbsp;
        链接地址:<input type="text" style='border:solid 1px #000000; color:#666666' name="url" id="url" size="12px" value="${req.url}"/>&nbsp;&nbsp;
...
<%--                    <td width="40px" align="center" bgcolor="">序号</td>--%>
        ...
        <td bgcolor='' align="center">链接地址</td>
            ...
            <td bgcolor="" align="center">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <td width="40px" align="center">
                            <a href="${contextPath}/lianjieDetailQian/${info.id}">
                                详细
                            </a>
                        </td>
                    </tr>
