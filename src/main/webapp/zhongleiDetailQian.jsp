...
<head>
    ...
    <script language="javascript">
        ...
        //跳转到子表shangpin添加页面
        function zhongleishangpinAddQian(id) {
            var url="${contextPath}/zhongleishangpinAddQian/"+id;
            window.location.href=url;
        }
        //跳转到子表shangpin查看页面
        function zhongleishangpinGetByzhongleiidQian(id) {
            var url="${contextPath}/zhongleishangpinGetByzhongleiidQian/"+id;
            window.location.href=url;
        }
    ...
    <tr>
        ...
        <td width="39%">
            ${zhonglei.mingcheng }
                ...
                <input type="button" value="商品添加" onclick="zhongleishangpinAddQian(${zhonglei.id})"/>
                <input type="button" value="商品查看" onclick="zhongleishangpinGetByzhongleiidQian(${zhonglei.id})"/>
