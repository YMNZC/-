...
public interface DxMapper {
    ...
    //插入信息介绍表dx的实体数据（包含null值）
    int insert(Dx record);

    //插入信息介绍表dx的实体数据（不包含null值）
